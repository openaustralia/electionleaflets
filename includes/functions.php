  ...
  function is_postcode ($postcode) {
	...
	function get_election($election_id = null) {
		...
		if (is_numeric($election_id)) {
                  ...
                  $_SESSION['election_id'] = CURRENT_ELECTION;
                }
        }
		...
		*/
		...
		if(is_numeric($postcode)) {
			...
			if(is_numeric($postcode_area_id)) {
				...
				$electorates_json = json_decode(file_get_contents("http://mapit.openlocal.org.au/area/" . $postcode_area_id . "/{$cover_type}?type={$types}"), true);
