{include file="header.tpl"}
    ...
    <div class="contentfull">
        ...
        <p>
            ...
            If you have recently received any election leaflets through your door you can help by photographing or scanning them and <a href="{$www_server}/addupload">uploading the images to our server</a>.
        </p>
        <p>
