...
<div class="contentfull">
        ...
        <p>Volunteers from all over the country have uploaded {$leaflet_count} leaflets to {$site_name}, <strong>but we don't have any leaflets at all for the constituencies listed below</strong>. They are, for the most part, <em>very</em> safe seats, could there be a connection?
        </p>
